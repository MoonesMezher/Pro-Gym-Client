...
const AdminLayout = ({ children }) => {
  ...
  let navItems = [
    {
      name: "Dashboard",
      icon: <FaHouse className="text-skin text-xl" />,
      href: "/admin",
    },
    {
      name: "Users",
      icon: <FaUser className="text-skin text-xl" />,
      href: "/admin/users",
    },
    justAdmin() && {
      name: "Coaches",
      icon: <FaUserNinja className="text-skin text-xl" />,
      href: "/admin/coaches",
    },
    {
      name: "Schedules",
      icon: <FaBox className="text-skin text-xl" />,
      href: "/admin/schedules",
    },
    justAdmin() && {
      name: "Sections",
      icon: <IoMdGrid className="text-skin text-xl" />,
      href: "/admin/sections",
    },
    justAdmin() && {
      name: "Logs",
      icon: <FaMessage className="text-skin text-xl" />,
      href: "/admin/logs",
    },
    {
      name: "Settings",
      icon: <FaGear className="text-skin text-xl" />,
      href: "/admin/settings",
    },
  ];
            ...
            <ul>
              {navItems?.map((item) => (
                <li key={item?.name} className="mb-1">
                  <Link
                    href={item?.href}
                    className={`flex items-center p-3 rounded-lg hover:bg-sky transition-all ${handleLinks(
                      item?.href
                    )}`}
                  >
                    {item?.icon}
            ...
            <div className="flex items-center justify-between px-6 py-4">
              ...
              <div className="flex items-center space-x-6">
                <div className="flex items-center">
                  ...
                  <span className="ml-3 text-main hidden md:inline">{`Hi, ${
                    data?.name?.split(" ")[0]
                  }`}</span>
                </div>
              </div>
